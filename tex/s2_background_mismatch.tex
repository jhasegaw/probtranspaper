...
\begin{center}
  \tikzstyle{pre2}=[<-,shorten <=3pt,>=stealth',thick, draw=black]
  \tikzstyle{post2}=[->,shorten >=3pt,>=stealth',thick, draw=black]
  \begin{tikzpicture}[
    ...
    \node[open] (n0) at (-4.5,1) {$h=$Utterance-language words\\\vspace*{0.1in}$<$$\vcenter{\hbox{\includegraphics[width=1in]{../figs/vaakpahachaan.png}}}$$>$};
