...
% MH: I think no, because it's been developed by people other than us.
%  I could see a subsection reviewing all of the variety of self-training 
%  methods, except that we are only testing one of the many methods
%  available.  An extensive review would cause reviewers to ask why
%  we only tested one method, to which the answer is ``it's not
%  interesting to re-implement lots and lots of other people's techniques.''
