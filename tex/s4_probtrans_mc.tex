...
%%
%% Also regarding this table, see comment in section s3_training_map
%% about language abbreviations. Of particular importance here is the
%% variety of Arabic used in the experiment, as there are 35 different
%% languages grouped under the macrolanguage "ara" (see here:
%% https://www.ethnologue.com/subgroups/arabic-0 )
