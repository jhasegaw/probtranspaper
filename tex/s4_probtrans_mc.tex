...
\begin{center}
  ...
  \begin{tikzpicture}[
    ...
    \node[boxed] (n1) at (6,0) {\begin{tiny}\begin{tabular}{c}$\rho(\lambda|T)=$Orthographic Confusion Network\\$\epsilon=$empty string\\\hline\vspace{3cm}\end{tabular}\end{tiny}} edge[pre] (n0);
    ...
    \node[boxed] (n2) at (12,0) {\begin{tiny}\begin{tabular}{c}$\rho(\phi|T)=$Phone Confusion Network\\$\emptyset=$empty phone\\\hline\vspace*{3cm}\end{tabular}\end{tiny}} edge[pre] (n1);
