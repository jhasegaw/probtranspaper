...
\label{tab:data}
\end{table}
%% note: assuming that the arabic spoken in SBS broadcasts is "modern
%% standard arabic" (SBS website doesn't say, but I think it's a fair
%% assumption). If not, it could be any of 30 or so distinct languages:
