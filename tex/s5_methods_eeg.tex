...
($N_{M2O}(\mathbb{V}_\phi)$) between the English phoneme inventory
($\mathbb{V}_\psi$) and the non-native phoneme inventory $\mathbb{V}_\phi$.
...
\begin{equation}
  N_{M2O}(\mathbb{V}_\phi)=\frac{1}{|\mathbb{V}_\psi|}\sum_{\phi_1\ne\phi_2}
  \delta\left(\psi^*(\phi_1)=\psi^*(\phi_2)\right)
\label{eq:m2o}
\end{equation}
where $|\mathbb{V}_\psi|$ is the size of the English phoneme inventory.
...
\begin{table}
  \centerline{\begin{tabular}{|lr|lr|lr|}\hline
    $\mathbb{V}_\phi$ & $N_{M2O}(\mathbb{V}_\phi)$ &
    $\mathbb{V}_\phi$ & $N_{M2O}(\mathbb{V}_\phi)$ &
    $\mathbb{V}_\phi$ & $N_{M2O}(\mathbb{V}_\phi)$ \\ \hline
  ...
  \end{tabular}}
  \caption{Frequency of many-to-one mappings $N_{M2O}(\mathbb{V}_\phi)$
    between phoneme inventory $\mathbb{V}_\phi$ and the inventory of
