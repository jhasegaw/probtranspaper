...
\end{tabular}}
\caption{LPER of the 1-best path: a measure of the quality of
  probabilistic transcriptions acquired from mismatched crowdsourcing.
  Probabilistic transcriptions were decoded using three different
  methods per language: universal phone set, target-language phone
  set, and target-language bigram phone language model.}
