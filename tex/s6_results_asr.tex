...
Code & ({\sc CL}) & ({\sc ST}) &  ({\sc PT-adapt}) & \% Rel. redn & \% Rel. redn\\
...
yue & 66.59 (65.41) & 63.79 (62.46) &\textbf{53.64 (53.80)} & 19.4** (17.7) & 15.9** (13.9) \\
...
\end{tabular}}
\caption{\label{tab:ptresult} PERs on the evaluation and development sets (development in parentheses) before and after adaptation with PTs.  MAPSSWE significance testing: * means $p\le 0.003$, ** means $p<0.001$.}
\end{table*}
