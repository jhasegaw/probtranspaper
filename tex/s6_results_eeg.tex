...
\begin{figure}
  \centerline{\includegraphics[width=\columnwidth]{../figs/diliberto_svmresults.png}}
  \vspace*{-0.3cm}
...
\begin{figure}
  \centerline{
    \includegraphics[width=0.45\columnwidth]{../figs/mirbagheri_dist_features.png}
    \includegraphics[width=0.45\columnwidth]{../figs/mirbagheri_dist_eeg.png}
  }
    \vspace*{-0.3cm}
